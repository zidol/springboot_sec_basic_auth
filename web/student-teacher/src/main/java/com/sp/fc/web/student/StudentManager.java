...
public class StudentManager implements AuthenticationProvider, InitializingBean {
    ...
    public boolean supports(Class<?> authentication) {
        return authentication == StudentAuthenticationToken.class || authentication == UsernamePasswordAuthenticationToken.class;           //basic http는 usernaem 과 password가 필요하기 때문에 UsernamePasswordAuthenticationToken를 다시 추가해줌
    }
