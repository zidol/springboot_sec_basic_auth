...
//                Map.of("name", "zidol", "price", 3000)
//        ).signWith(SignatureAlgorithm.HS256, "zidol")
//                .compact();
//        System.out.println("okta_token = " + okta_token);
//        printToken(okta_token);
//
//        Jws<Claims> tokenInfo = Jwts.parser().setSigningKey("zidol").parseClaimsJws(okta_token);
...
//    @Test
//    void test_2() {
//        byte[] SEC_KEY = DatatypeConverter.parseBase64Binary("zidol");
//
//        String oauth0_token = JWT.create().withClaim("name", "zidol").withClaim("price", 3000)
...
//
//        final Algorithm AL = Algorithm.HMAC256("zidol");
//        String token = JWT.create()
//                .withNotBefore(new Date(System.currentTimeMillis() + 1000))
//                .withSubject("a1234").withExpiresAt(new Date(System.currentTimeMillis() + 3000))
//                .sign(AL);
//
////        Thread.sleep(2000);
//        try {
